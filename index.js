  ...
  .createServer((req, res) => {
    ...
    switch (req.method) {
      case "GET":
        if (req.url === "/") {
          res.write(
            '<!DOCKTYPE html><html lang="ja"><body>' +
              "<h1>アンケートフォーム</h1>" +
          ...
          res.write(
            '<!DOCKTYPE html><html lang="ja"><body>' +
              "<h1>アンケートフォーム</h1><ul>" +
              '<li><a href="/enquetes/yaki-shabu">焼肉・しゃぶしゃぶ</li>' +
              '<li><a href="/enquetes/rice-bread">ごはん・パン</li>' +
              '<li><a href="/enquetes/sushi-pizza">寿司・ピザ</li>' +
              "</ul></body></html>"
          );
